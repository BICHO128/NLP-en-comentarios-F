        ...
        <div className="p-6">
          ...
          <div className="p-6 text-center bg-white rounded-lg shadow">
            ...
            <p className="text-xl text-gray-700">
              Bienvenido al panel de administración del sistema de evaluación docente. Aquí podrá visualizar los resultados de las evaluaciones realizadas por los estudiantes, incluyendo análisis de comentarios y gráficos estadísticos.
            </p>
            <p className="mt-4 text-lg font-semibold text-gray-700">
              Puede descargar un reporte general con todas las evaluaciones disponibles hasta la fecha.
            </p>
          ...
          {selectedTeacher && selectedCourse && (
            <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
              <button
                ...
                className="px-4 py-2 text-white transition bg-blue-700 rounded-md hover:bg-gray-400 hover:text-blue-700"
              >
                Ver Evaluaciones
              </button>
              <button
