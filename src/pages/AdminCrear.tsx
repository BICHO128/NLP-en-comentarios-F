    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.status === 201 || res.status === 200) {
                ...
                // Errores específicos enviados por el backend en "errors"
                setErrors(data.errors);
            } else {
                // Detección de errores generales en "error"
                ...
                toast.error(data.error || data.msg || "Error al crear. Intenta de nuevo.");
            }
        } catch {
            setLoading(false);
            toast.error("Error ");
