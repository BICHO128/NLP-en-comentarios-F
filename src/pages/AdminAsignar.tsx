    ...
    return (
        ...
        >
            ...
            <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 mb-12">
                ...
                <div
                    className={`max-w-6xl mx-auto rounded-3xl shadow-lg overflow-hidden ${isDarkMode
                        ...
                        <div className="p-6">
                            <div className="flex flex-col md:flex-row gap-8 justify-center items-start w-full">
                                ...
                                <div className="w-full md:w-1/3">
                                    <h2
                                        className={`text-2xl font-bold mb-4 text-center ${isDarkMode ? "text-blue-700" : "text-blue-700"
                                            }`}
                                    >
                                ...
                                {/* Línea divisoria */}
                                <div
                                    className={`hidden md:block border-r-4 ${isDarkMode ? "border-blue-500" : "border-cyan-300"
                                        } h-[260px] mx-2`}
                                />
                                            ...
                                            {cursosPorAsignar.map((curso) => (
                                                ...
                                                >
                                                    ...
                                                    {cursosSeleccionados.includes(curso.id) && (
                                                        <span
                                                            className={`ml-4 font-bold text-2xl ${isDarkMode
                                                                ? "text-green-700"
                                                                : "text-green-500"
                                                                }`}
                                                        >
                                        ...
                                        <AnimatePresence>
                                            {cursosAsignados.map((curso) => (
                                                ...
                                                >
                                                    <span className="font-medium">{curso.nombre}</span>
                                                    <button
                                                        className={`ml-2 rounded-3xl p-2 transition ${loadingEliminar === curso.id
                                                            ? "bg-gray-500"
                                                            : isDarkMode
